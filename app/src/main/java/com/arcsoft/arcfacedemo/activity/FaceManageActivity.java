...
public class FaceManageActivity extends AppCompatActivity {
    ...
    private void doRegister() {
        ...
        if (!dir.exists()) {
            Toast.makeText(this, getString(R.string.batch_process_path_is_not_exists, REGISTER_DIR), Toast.LENGTH_SHORT).show();
            return;
        }
        if (!dir.isDirectory()) {
            Toast.makeText(this, getString(R.string.batch_process_path_is_not_dir, REGISTER_DIR), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void clearFaces(View view) {
        ...
        if (faceNum == 0) {
            Toast.makeText(this, R.string.batch_process_no_face_need_to_delete, Toast.LENGTH_SHORT).show();
        } else {
